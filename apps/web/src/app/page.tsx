export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-50 dark:bg-[#121212]">
      <div className="max-w-4xl w-full text-center">
        <h1 className="text-5xl font-bold mb-6 text-primary-700 dark:text-[#39ff14]">
          Sistema de Préstamos
        </h1>
        <p className="text-xl text-gray-600 mb-8 dark:text-white/60">
